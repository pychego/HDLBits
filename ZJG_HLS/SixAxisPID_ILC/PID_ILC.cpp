             ...
             bit16 *control_output3, bit16 *control_output4, bit16 *control_output5)
{
    ...
    static short ILC_control[6][10000] = {0};
    ...
    *control_output0 = round(control_output_reg[0]) + 32768;
    *control_output1 = round(control_output_reg[1]) + 32768;
    *control_output2 = round(control_output_reg[2]) + 32768;
    *control_output3 = round(control_output_reg[3]) + 32768;
    *control_output4 = round(control_output_reg[4]) + 32768;
    *control_output5 = round(control_output_reg[5]) + 32768;
}
