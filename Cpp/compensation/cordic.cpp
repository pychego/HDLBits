...
float cordic_phase[NUM_ITERATIONS] = {45, 26.56505118, 14.03624347, 7.12506349, 3.576334375, 1.789910608,
                                      0.8951737102, 0.4476141709, 0.2238105004, 0.1119056771, 0.05595289189,
                                      0.02797645262, 0.01398822714, 0.006994113675, 0.003497851056, 0.001748528427,
                                      0.0008742642137, 0.0004371321069, 0.0002185660534, 0.0001092830267};

void cordic(float theta, float *s, float *c)
{
    // Set the initial vector that we will rotate
    // current_cos = I;current = Q
    float current_cos = 0.607252935;
